...
with dpg.window(
    ...
    dpg.add_input_int(label='radius', width=100,
                      pos=(70, 120), default_value=50)
    dpg.add_input_float(label='lambda', width=100,
...
with dpg.window(
    ...
    dpg.add_image("image", show=True, tag='image_data', pos=(10, 30), width=int(dpg.get_item_width("image") * scale), height=int(dpg.get_item_height("image") * scale))
